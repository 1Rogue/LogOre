...
/**
 * Handles the update process for {@link LogOre}
 *
 * @since 1.0.0
 * @author 1Rogue
 * @version 1.0.0
...
public class UpdateHandler {
     ...
     */
    public UpdateHandler(LogOre plugin, Choice choice, int id, String file) {
        this.plugin = plugin;
        this.choice = choice;
        this.id = id;
        this.file = file;
...
class UpdateRunnable extends UpdateHandler implements Runnable {
     ...
     * @version 1.0.0
     *
     * @param plugin The {@link LogOre} instance
     * @param choice The {@link Choice} for downloading
     * @param id The project id
     * @param file The name of the plugin file
     */
    public UpdateRunnable(LogOre plugin, Choice choice, int id, String file) {
     ...
     * @version 1.0.0
     *
     * @return True if {@link LogOre} is latest version, false otherwise
     */
